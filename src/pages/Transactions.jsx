  ...
  return (
    <div className="space-y-6 p-6 bg-white rounded-3xl shadow-sm">
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="overflow-hidden rounded-3xl border border-[#ececf2] bg-white shadow-sm row-span-1 self-start">
          <div className="relative">
            ...
            <div className="p-5">
              ...
              {cart.length === 0 ? (
                <div className="flex h-64 items-center justify-center rounded-2xl border border-dashed border-[#ececf2]">
                ...
                <>
                  ...
                  <div className="mt-4 pt-4 border-t border-[#ececf2] space-y-3">
                    <div className="flex items-center justify-between">
                    ...
                    <div className="border-t border-[#ececf2] pt-3 flex items-center justify-between">
